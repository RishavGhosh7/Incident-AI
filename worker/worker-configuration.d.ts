/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 50f7f1ed78e9abbd8133e186b6ad33e1)
// Runtime types generated with workerd@1.20260921.1 2025-09-22 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	AI: Ai;
	ASSETS: Fetcher;
	INCIDENT: DurableObjectNamespace<import("./src/index").IncidentDO>;
	INCIDENT_WORKFLOW: Workflow<Parameters<import("./src/index").IncidentAnalysisWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "IncidentDO";
	}
